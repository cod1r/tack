...
external freetype_init_library
  :  unit
  -> ft_library
  = "freetype_init_library" "freetype_init_library"

external freetype_get_face
  :  string
  -> ft_library
  -> ft_face
  = "freetype_get_face" "freetype_get_face"

external freetype_done_face : ft_face -> unit = "freetype_done_face" "freetype_done_face"

external freetype_set_char_size
  :  ft_face
  -> int
  -> unit
  = "freetype_set_char_size" "freetype_set_char_size"

external freetype_set_pixel_sizes
  :  ft_face
  -> int
  -> unit
...
let font_size = Yojson.Safe.Util.member "ui_font_size" config |> Yojson.Safe.Util.to_int
...
let get_text_texture_atlas_info ~(glyph_info_with_char : (char * glyph_info_) Array.t) =
  let face = face in
