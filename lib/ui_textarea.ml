  ...
  | Some r -> (
      ...
      | _ -> (
          ...
          | '\b' when kbd_evt_type = Keydown ->
              ...
              if rope_len > 0 && Option.is_some text_area_information.cursor_pos
              then
                let cursor_pos = Option.get text_area_information.cursor_pos in
                let new_rope =
                  Some
                ...
                in
                { text_area_information with text = new_rope }
