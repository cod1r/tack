...
external gl_scissor : x:int -> y:int -> width:int -> height:int -> unit
  = "gl_scissor" "gl_scissor"

external gl_disable_scissor : unit -> unit
  = "gl_disable_scissor" "gl_disable_scissor"

external gl_enable_scissor : unit -> unit
  = "gl_enable_scissor" "gl_enable_scissor"
...
external gl_get_viewport : unit -> int * int * int * int
